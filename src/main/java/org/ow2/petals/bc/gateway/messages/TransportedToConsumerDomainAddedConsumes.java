...
public class TransportedToConsumerDomainAddedConsumes extends TransportedForService {
    ...
    public TransportedToConsumerDomainAddedConsumes(final ServiceKey key, final @Nullable Document description) {
        super(key);
