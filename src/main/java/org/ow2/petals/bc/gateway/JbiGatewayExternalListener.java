...
public class JbiGatewayExternalListener extends AbstractExternalListener {
    ...
    public void start() throws PEtALSCDKException {
        // TODO Register the listener to the component's transports so that it can handle exchanges for it
    }

    @Override
    public void stop() throws PEtALSCDKException {
        // TODO Remove the listener from the component's transports so that it stops handling exchange for it
    }
