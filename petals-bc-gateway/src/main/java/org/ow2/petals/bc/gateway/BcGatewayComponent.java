 ...
 * 
 * For external exchange handling, see {@link BcGatewayJBISender} and {@link TransportListener}.
 * 
 * For internal exchange handling, see {@link BcGatewayJBIListener}.
 * 
 * For SU management, see {@link BcGatewaySUManager}.
 * 
 * @author vnoel
 *
 */
public class BcGatewayComponent extends AbstractBindingComponent implements ProviderMatcher, AdminRuntimeService {
    ...
    protected void doInit() throws JBIException {
        sender = new BcGatewayJBISender(this);
        ...
        for (final JbiTransportListener jtl : BcGatewayJbiHelper
    ...
    public void addTransportListener(final @Nullable String id, final int port) throws PetalsException {
        ...
        try {
            final JbiTransportListener jtl = BcGatewayJbiHelper.addTransportListener(id, port,
    ...
    public void setTransportListenerPort(final @Nullable String id, final int port) throws PetalsException {
        ...
        try {
            final JbiTransportListener jtl = BcGatewayJbiHelper.setTransportListenerPort(id, port,
                    this.getJbiComponentDescriptor().getComponent());
