...
public interface EnsurePortsAreOK {
    ...
    public static void assertAvailable(final int port) {
        assertAvailable(port, true);
    }

    public static void assertNotAvailable(final int port) {
        assertAvailable(port, false);
    }

    private static void assertAvailable(final int port, final boolean is) {
