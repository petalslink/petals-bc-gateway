...
public class BcGatewaySendTest extends AbstractComponentTest {
    ...
    public void testTimeout() throws Exception {
        ...
        final FlowLogData consumerDomainConsumerExtBeginFlowLogData = assertMonitConsumerExtBeginLog(monitLogs.get(2));
        ...
        final List<LogRecord> warnRecords = IN_MEMORY_LOG_HANDLER
